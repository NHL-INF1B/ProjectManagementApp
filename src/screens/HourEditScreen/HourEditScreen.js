...
const HourEditScreen = () => {
  ...
  return (
    <ScrollView style={styles.root}>
        ...
        <Pressable onPress={() => sendDataToAPI("title", "description", "date", "time_start", "time_end", "user_id", "project_id")}>
        ...
        <Pressable>
            <Text style={[styles.button, styles.buttonRed, styles.marginTop1, styles.marginBottom5]}>Stop</Text>
        </Pressable>
    </ScrollView>
  );
}

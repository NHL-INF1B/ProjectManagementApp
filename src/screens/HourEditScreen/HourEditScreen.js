  ...
  const catchFeedback = (response) => {
    switch (response) {
      ...
      case "data_updated":
        ...
        navigation.navigate("LogbookScreen", { projectId, userId });
        break;
      case "data_deleted":
      ...
      <ScrollView>
        ...
        <View style={styles.marginBottom5}>
          <CustomButton
            ...
            onPress={() =>
              Alert.alert(
                "Weet je zeker dat je deze urenverantwoording wilt verwijderen?",
                "Er is geen mogelijkheid om dit terug te draaien!",
                [
